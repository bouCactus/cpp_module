...
{
    std::cout << "first name    : " << phoneNumber.first_name << std::endl;
    std::cout << "last name     : " << phoneNumber.last_name << std::endl;
    std::cout << "nickname      : " << phoneNumber.nickname << std::endl;
    std::cout << "phone number  : " << phoneNumber.phone_num << std::endl;
    std::cout << "darkest secret: " << phoneNumber.darkest_secret << std::endl;
}